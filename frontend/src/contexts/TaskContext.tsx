...
import type { Task, CreateTaskData, UpdateTaskData, FilterOptions } from '../types/index.ts';
import apiService from '../services/api.ts';
import { useAuth } from './AuthContext.tsx';

interface TaskContextType {
  tasks: Task[];
  isLoading: boolean;       // loading for mutations (create/update/delete/toggle)
  isFetching: boolean;      // loading for fetchTasks
  error: string | null;
...
export const TaskProvider: React.FC<TaskProviderProps> = ({ children }) => {
  ...
  const value = useMemo(() => ({
    ...
    clearFilters,
    refreshTasks,
  }), [tasks, isLoading, isFetching, error, filters]);
